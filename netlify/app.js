document.addEventListener("DOMContentLoaded", async function () {
    ...
    async function checkWalletConnection() {
        try {
            const response = await fetch("https://cool-kataifi-90a5d5.netlify.app/wallet-status", {
                method: "GET",
                credentials: "include",
            });
    ...
    function connectWallet() {
        if (/Android|iPhone/i.test(navigator.userAgent)) {
            ...
            const deeplink = `https://phantom.app/ul/v1/connect?app_url=${encodeURIComponent("https://cool-kataifi-90a5d5.netlify.app")}&dapp_encryption_public_key=&cluster=mainnet-beta&redirect_link=${encodeURIComponent("https://cool-kataifi-90a5d5.netlify.app/wallet-status")}`;
